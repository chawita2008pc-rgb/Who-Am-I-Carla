...
const ScrollExpandMedia = ({
  ...
  useEffect(() => {
    ...
    const handleScroll = (): void => {
      if (!sectionRef.current) return;
      const rect = sectionRef.current.getBoundingClientRect();
      if (!mediaFullyExpanded && rect.top <= 5 && rect.top >= -5) {
            ...
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-4 transition-none'>
                  {date && (
                    <p
                      className='text-xl md:text-2xl text-blue-400 font-mono tracking-widest uppercase'
                  ...
                  {scrollToExpand && (
                    <p
                      className='text-slate-300 font-medium text-sm md:text-base tracking-widest uppercase mt-4 opacity-70'
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                ...
                <motion.h2
                  className='text-5xl md:text-7xl lg:text-9xl font-black text-center text-transparent tracking-tighter style-outline uppercase'
                  style={{ 
